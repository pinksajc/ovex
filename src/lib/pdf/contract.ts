...
<div style="break-before:page; ${PAGE}">
  ...
  <div style="break-before:page;">
    ...
    <p style="font-size:8px;color:#64748b;line-height:1.5;">EEE = Espacio Económico Europeo. Las pasarelas de pago las contrata el Cliente (responsables independientes). Glovo/Uber/JustEat (REN) son responsables independientes. Square (u otra plataforma de terceros) es fuente/plataforma del Cliente, responsable independiente y no subencargado de Platomico, tanto en la migración puntual (2ª bis, Ap. A) como en el acceso continuado (2ª bis, Ap. B). Ver PLT-VEN-001.</p>
    <p style="font-size:8px;color:#94a3b8;font-style:italic;line-height:1.5;margin-top:3px;">EEA = European Economic Area. Payment gateways are contracted by the Client (independent controllers). Glovo/Uber/JustEat (REN) are independent controllers. Square (or any other third-party platform) is the Client’s source/platform, an independent controller and not a sub-processor of Platomico, both for the one-off migration (Cl. 2ª bis, Sec. A) and for ongoing access (Cl. 2ª bis, Sec. B). See PLT-VEN-001.</p>
  </div>
</div>
